...
@rag_chat.post('/chat', status_code=200)
async def chat_whit_history_and_context_documents(chat_payload: ChatPayload = Body(...)):
...
@rag_chat.post('/upload', status_code=200)
def document_upload(upload_payload: str = Body(...)):
